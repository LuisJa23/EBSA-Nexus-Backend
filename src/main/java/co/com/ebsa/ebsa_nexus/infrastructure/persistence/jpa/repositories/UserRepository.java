...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    boolean existsByDocumentNumberAndIdNot(@Param("documentNumber") String documentNumber, @Param("id") Long id);
    ...
    @Query("SELECT u FROM User u JOIN u.role r WHERE u.active = true AND r.name != 'ADMIN' AND u.id NOT IN (SELECT cm.userId FROM CrewMemberEntity cm WHERE cm.leftAt IS NULL)")
